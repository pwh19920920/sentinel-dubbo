 ...
 * @since 1.4.0
 */
public class FlowRuleNacosPublisher implements DynamicRuleNacosPublisher<FlowRuleEntity> {
    ...
    public FlowRuleNacosPublisher(ConfigService configService, DashboardProperties dashboardProperties) {
