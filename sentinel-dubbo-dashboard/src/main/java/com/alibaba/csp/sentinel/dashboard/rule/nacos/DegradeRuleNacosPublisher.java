 ...
 * @since 1.4.0
 */
public class DegradeRuleNacosPublisher implements DynamicRuleNacosPublisher<DegradeRuleEntity> {
    ...
    public DegradeRuleNacosPublisher(ConfigService configService, DashboardProperties dashboardProperties) {
