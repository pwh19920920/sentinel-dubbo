 ...
 * @since 1.4.0
 */
public class ParamFlowRuleNacosPublisher implements DynamicRuleNacosPublisher<ParamFlowRuleEntity> {
    ...
    public ParamFlowRuleNacosPublisher(ConfigService configService, DashboardProperties dashboardProperties) {
