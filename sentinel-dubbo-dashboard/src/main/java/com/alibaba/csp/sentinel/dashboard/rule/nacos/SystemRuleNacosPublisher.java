 ...
 * @since 1.4.0
 */
public class SystemRuleNacosPublisher implements DynamicRuleNacosPublisher<SystemRuleEntity> {
    ...
    public SystemRuleNacosPublisher(ConfigService configService, DashboardProperties dashboardProperties) {
