...
import com.taobao.csp.sentinel.dashboard.rule.DynamicRuleZookeeperPublisher;
 ...
 * @since 1.4.0
 */
public class ParamFlowRuleZookeeperPublisher implements DynamicRuleZookeeperPublisher<ParamFlowRuleEntity> {
